...
export const teamMembers = [
  {
    ...
    role: 'Advogado sócio',
    oab: 'OAB/PI 00.000',
    image: asset('team-rafael.svg'),
    imageAlt: 'Retrato profissional demonstrativo de Rafael Almeida em ambiente jurídico',
  ...
  },
  {
    ...
    role: 'Advogada sócia',
    oab: 'OAB/PI 00.001',
    image: asset('team-marina.svg'),
    imageAlt: 'Retrato profissional demonstrativo de Marina Castro em ambiente jurídico',
